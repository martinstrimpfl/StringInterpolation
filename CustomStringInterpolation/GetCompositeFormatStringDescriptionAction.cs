...
{
    public class GetCompositeFormatStringDescriptionAction : IGetCompositeFormatStringDescriptionAction
    {
        public ICompositeFormatStringDescription Execute(string interpolatedFormatValue)
        {
        ...
        private class Reader
        {
            ...
            public ICompositeFormatStringDescription Process()
            {
